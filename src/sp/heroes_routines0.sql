...
CREATE DEFINER=`root`@`localhost` PROCEDURE `createAccount`(
    ...
    in _userType varchar(15))
BEGIN
	DECLARE message varchar(50) DEFAULT "Creating account was successfull.";
    DECLARE code int DEFAULT 200;
	INSERT INTO account(fname, lname, email, password, userType) 
    VALUES(_fname, _lname, _email, _password, _userType);
...
/*!50003 DROP PROCEDURE IF EXISTS `createHero` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `createHero`(
	in _name varchar(30), 
    in _power varchar(30), 
    in _description text)
BEGIN
	DECLARE message VARCHAR(30) DEFAULT "Creating hero was successfull.";
	INSERT INTO hero (name, power, description) VALUES(_name, _power, _description);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getAllHero`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `loginAccount` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `loginAccount`(in _email varchar(30), in password varchar(30))
BEGIN
	DECLARE isPass BOOL DEFAULT false;
    DECLARE message VARCHAR(30) DEFAULT "Invalid user";
    DECLARE code INT DEFAULT 404;
    DECLARE pass VARCHAR(30) DEFAULT "default-";
    
    SELECT AC.password FROM ACCOUNT as AC WHERE AC.email = _email INTO pass;
    
    IF pass = 'default-' THEN
		SET message = "User is not found";
        SET CODE = 404;
	ELSE 
		SET message = "User is found";
        SET CODE = 200;
    END IF;
    
    SELECT _email, pass, message, code;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2024-06-10 17:14:55
